...
/**
 * 10/28/2014 - Brian Peterson copied this file into project from Soot Examples.  I did not write this file
 * I did edit it in a minimal way to attempt to change it from
 * backwardflowanalysis to forward branched flow analysis,
 *  but I eventually decided to temporarily abandon this goal as I don't see why we would care
 *  about forward or backward flow analysis.
 */
